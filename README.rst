...
*******************************
Packaging for 'python27' filter
*******************************

This repo contains the scripts used to create a foglamp-filter-python27 Debian package.
...
.. code-block:: console
  ...
  This script is used to create the Debian package of FoglAMP C++ 'python27' filter plugin
  Arguments:
...
.. code-block:: console
   ...
   dpkg-deb: building package 'foglamp-filter-scale' in 'foglamp-filter-python27-1.0.0-x86_64.deb'.
   Building Complete.
   $
